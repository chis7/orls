...
class OrlsPaedsPhlebotomyOlderChildrenLogLines(models.Model):
    _name = "orls.paeds.phlebotomy.older.children.log.lines"
    _description = "Orls Paeds Phlebotomy Older Children Log Lines"

    orls_paeds_phlebotomy_older_children_log_id = fields.Many2one(
