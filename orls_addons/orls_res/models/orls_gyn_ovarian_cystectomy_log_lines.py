...
class OrlsGynOvarianCystectomyLogLines(models.Model):
    _name = "orls.gyn.ovarian.cystectomy.log.lines"
    _description = "Orls Gyn Ovarian Cystectomy Lines Log Lines"

    orls_gyn_ovarian_cystectomy_log_id = fields.Many2one(
