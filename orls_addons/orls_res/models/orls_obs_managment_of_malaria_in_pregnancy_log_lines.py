...
class OrlsObsManagementOfMalariaInPregnancyLogLines(models.Model):
    _name = "orls.obs.management.of.malaria.in.pregnancy.log.lines"
    _description = "Orls Obs Management Of Malaria In Pregnancy Log Lines"

    orls_management_of_malaria_in_pregnancy_log_id = fields.Many2one(
