...
class OrlsObsCounsellingOnFamilyPlanningLogLines(models.Model):
    _name = "orls.obs.counselling.family.planning.log.lines"
    _description = "Orls Obs Counselling On Family Planning Methods Log Lines"

    orls_obs_counselling_on_family_planning_log_id = fields.Many2one(
