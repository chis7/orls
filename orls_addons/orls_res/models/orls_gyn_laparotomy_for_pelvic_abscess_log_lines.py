...
class OrlsGynLaparotomyForPelvicAbscessLogLines(models.Model):
    _name = "orls.gyn.laparotomy.pelvic.abscess.log.lines"
    _description = "Orls Gyn Laparotomy For Pelvic Abscess Log Lines"

    orls_gyn_laparotomy_pelvic_abscess_log_id = fields.Many2one(
