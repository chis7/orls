...
class OrlsGynLaparoscopicSurgeryLogLines(models.Model):
    _name = "orls.gyn.laparoscopic.surgery.log.lines"
    _description = "Orls Gyn Laparoscopic surgery Log Lines"

    orls_gyn_laparoscopic_surgery_log_id = fields.Many2one(
