...
class OrlsObsEpisiotomyLogLines(models.Model):
    _name = "orls.obs.episotomy.log.lines"
    _description = "Orls Obs Episiotomy Log Lines"

    orls_obs_episiotomy_log_id = fields.Many2one(
