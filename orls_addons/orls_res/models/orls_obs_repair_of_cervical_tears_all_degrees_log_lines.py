...
class OrlsObsRepairOfCervicalTearsAllDegreesLogLines(models.Model):
    _name = "orls.obs.repair.of.cervical.tears.all.degrees.log.lines"
    _description = "Orls Obs Repair Of Cervical Tears All Degrees Log Lines"

    orls_obs_repair_of_cervical_tears_all_degrees_log_id = fields.Many2one(
