...
class OrlsObsCeasareanLogLines(models.Model):
    _name = "orls.obs.ceasarean.log.lines"
    _description = "Orls Obs Ceasarean Log Lines"

    orls_obs_ceasarean_log_id = fields.Many2one(
