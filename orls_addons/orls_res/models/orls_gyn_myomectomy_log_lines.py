...
class OrlsGynMyomectomyLogLines(models.Model):
    _name = "orls.gyn.myomectomy.log.lines"
    _description = "Orls Gyn Myomectomy Log Lines"

    orls_gyn_myomectomy_log_id = fields.Many2one(
