...
class OrlsGynMyomectomyLines(models.Model):
    _name = "orls.gyn.myomectomy.lines"
    _description = "Orls Gyn Myomectomy Lines"

    orls_gyn_myomectomy_main_id = fields.Many2one(
