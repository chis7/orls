...
class OrlsGynLaparatomyForEctopicPregnancyLogLines(models.Model):
    _name = "orls.gyn.laparatomy.ectopic.preg.log.lines"
    _description = "Orls Gyn Laparatomy For Ectopic Pregnancy Log Lines"

    orls_gyn_laparatomy_ectopic_pregnancy_log_id = fields.Many2one(
