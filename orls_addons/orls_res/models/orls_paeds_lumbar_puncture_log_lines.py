...
class OrlsPaedsLumbarPunctureLogLines(models.Model):
    _name = "orls.paeds.lumbar.puncture.log.lines"
    _description = "Orls Paeds Lumbar Puncture Log Lines"

    orls_paeds_lumbar_puncture_log_id = fields.Many2one(
