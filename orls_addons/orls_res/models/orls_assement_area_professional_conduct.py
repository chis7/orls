...
class OrlsAssessmentAreaProfessionalConduct(models.Model):
    _name = "orls.overall_assessment.area.professional.conduct.lines"
    _inherit = ["mail.thread"]
    _description = "Orls Overall Assessment Area Professional Conduct"

    name = fields.Selection(selection=[
        ("toPatientsAndCaregivers", "To patients and caregivers"),
        ("toSeniorsColleaguesAndOtherHealthWorkers", "To seniors, colleagues and other health workers"),
        ("manifestsSincerityIntegrityAndHonestyInActsAndDeeds", "Manifests sincerity, integrity and honest in acts and deeds"),
        ("toThePublic", "To the public"),
        ("punctualityAvailabilityAndTimeManagement", "Punctuality, availability and Time management")
    ], string="Competence")
    ...
    # orls_overall_grading_assessment_area_professional_conduct_lines_id = fields.Many2one(
