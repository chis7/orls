...
class OrlsGynVaginalHysterectomyLogLines(models.Model):
    _name = "orls.gyn.vaginal.hysterectomy.log.lines"
    _description = "Orls Gyn Vaginal Hysterectomy Log Lines"

    orls_gyn_vaginal_hysterectomy_log_id = fields.Many2one(
