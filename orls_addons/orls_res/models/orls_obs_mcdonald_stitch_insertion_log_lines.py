...
class OrlsObsMcDonaldStitchInsertionLogLines(models.Model):
    _name = "orls.obs.mcdonald.stitch.insertion.log.lines"
    _description = "Orls Obs McDonald Stitch insertion Log Lines"

    orls_obs_mcdonald_stitch_insertion_log_id = fields.Many2one(
