...
class OrlsGynTotalAbdominalHysterectomyLogLines(models.Model):
    _name = "orls.gyn.total.abdominal.hysterectomy.log.lines"
    _description = "Orls Gyn Total Abdominal Hysterectomy Log Lines"

    orls_gyn_total_abdominal_hysterectomy_log_id = fields.Many2one(
