...
class OrlsObsRepairOfPerinealTearsLogLines(models.Model):
    _name = "orls.obs.repair.of.perineal.tears.log.lines"
    _description = "Orls Obs Management Of Anemia In Pregnancy Log Lines"

    orls_obs_repair_of_perineal_tears_log_id = fields.Many2one(
