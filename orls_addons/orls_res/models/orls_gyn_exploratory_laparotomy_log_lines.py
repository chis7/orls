...
class OrlsGynExploratoryLaparotomyLogLines(models.Model):
    _name = "orls.gyn.exploratory.laparotomy.log.lines"
    _description = "Orls Gyn Exploratory Laparotomy Log Lines"

    orls_gyn_exploratory_laparotomy_log_id = fields.Many2one(
