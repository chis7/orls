...
class OrlsPaedsResidentLog(models.Model):
    _name = "orls.paeds.resident.log"
    _inherit = ["mail.thread"]
    _description = "Orls Paeds Resident Log"
    ...
    orls_paeds_ascitic_tap_ids = fields.One2many(
        'orls.paeds.ascitic.tap.log.lines',
        'orls_ascitic_tap_log_id',
        string="Ascitic Tap 2(p)"
    )

    orls_paeds_exchange_transfusion_log_ids = fields.One2many(
        'orls.paeds.exchange.transfusion.log.lines',
