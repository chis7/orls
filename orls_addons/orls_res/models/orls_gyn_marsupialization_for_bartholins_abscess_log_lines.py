...
class OrlsMarsupializationForBartholinsAbscessLogLines(models.Model):
    _name = "orls.gyn.marsupialization.bartholins.log.lines"
    _description = "Orls Gyn Marsupialization For Bartholins Abscess Log Lines"

    orls_gyn_marsupialization_for_bartholins_abscess_log_id = fields.Many2one(
