...
class OrlsObsObstetricUltrasoundLogLines(models.Model):
    _name = "orls.obs.obstetric.ultrasound.log.lines"
    _description = "Orls Obs Obstetric Ultrasound Log Lines"

    orls_obs_obstetric_ultrasound_log_id = fields.Many2one(
