...
class OrlsIntMedRotationsProcedures(models.Model):
    _name = "orls.intmed.procedures"
    _inherit = ["mail.thread"]
    _description = "Orls Internal Medicine Procedures"
    ...
    orls_intmed_lumbar_puncture_main_ids = fields.One2many(
        'orls.intmed.lumbar.puncture.lines',
        'orls_intmed_lumbar_puncture_main_id',
        string="Lumbar puncture 5(p)"
    )

    orls_intmed_pleural_tap_main_ids = fields.One2many(
        'orls.intmed.pleural.tap.lines',
        'orls_intmed_pleural_tap_main_id',
        string="Pleural tap 5(p)"
    )

    orls_intmed_bone_marrow_aspirate_main_ids = fields.One2many(
        'orls.intmed.bone.marrow.aspirate.lines',
        'orls_intmed_bone_marrow_aspirate_main_id',
