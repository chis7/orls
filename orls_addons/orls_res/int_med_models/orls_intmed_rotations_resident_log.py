...
class OrlsIntMedResidentLog(models.Model):
    _name = "orls.intmed.resident.log"
    _inherit = ["mail.thread"]
    _description = "Orls Internal Medicine Resident Log"
    ...
    orls_intmed_lumbar_puncture_log_ids = fields.One2many(
        'orls.intmed.lumbar.puncture.log.lines',
        'orls_intmed_lumbar_puncture_log_id',
        string="Lumbar puncture 5(p)"
    )

    orls_intmed_pleural_tap_log_ids = fields.One2many(
        'orls.intmed.pleural.tap.log.lines',
        'orls_intmed_pleural_tap_log_id',
        string="Pleural tap 5(p)"
    )

    orls_intmed_bone_marrow_aspirate_log_ids = fields.One2many(
        'orls.intmed.bone.marrow.aspirate.log.lines',
        'orls_intmed_bone_marrow_aspirate_log_id',
        string="Pleural tap 5(p)"
    )
