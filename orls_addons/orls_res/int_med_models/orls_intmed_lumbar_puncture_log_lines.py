...
class OrlsIntMedLumbarPunctureLogLines(models.Model):
    _name = "orls.intmed.lumbar.puncture.log.lines"
    _description = "Orls Internal Medicine Lumbar puncture Log Lines"

    orls_intmed_lumbar_puncture_log_id = fields.Many2one(
