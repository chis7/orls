...
class OrlsIntMedPleuralTapLines(models.Model):
    _name = "orls.intmed.pleural.tap.lines"
    _description = "Orls Internal Medicine Pleural tap Lines"

    orls_intmed_pleural_tap_main_id = fields.Many2one(
